...
class QuickSort:
    ...
    def __particona(self, numero:'Lista de numero', inicio: int, fim: int)->None:
        if fim - inicio > 0:
            ...
            self.__particona(self.__numeros, inicio, direita)
            self.__particona(self.__numeros, esquerda, fim)
